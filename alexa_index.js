...
const HelloWorldIntentHandler = {
    ...
    handle(handlerInput) {
        const speechText = 'Hey there! How you Doing?';
        return handlerInput.responseBuilder
            .speak(speechText)
...
const GreetingIntentHandler = {
    ...
    handle(handlerInput) {
        const speechText = 'Nice to know that. Have a great day';
        return handlerInput.responseBuilder
            .speak(speechText)
            //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
            .getResponse();
...
const DangerIntentHandler = {
    canHandle(handlerInput) {
        return handlerInput.requestEnvelope.request.type === 'IntentRequest'
            && handlerInput.requestEnvelope.request.intent.name === 'DangerIntent';
    },
    handle(handlerInput) {
        const speechText = 'Sending you help ASAP';
        return handlerInput.responseBuilder
            .speak(speechText)
            //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
            .getResponse();
